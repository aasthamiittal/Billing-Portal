// Central permission-key map (single source of truth for readable checks).
// A key maps to either:
//  - a single descriptor { category, action, level }
//  - OR a composite descriptor { allOf: [ {category, action, level}, ... ] }
//
